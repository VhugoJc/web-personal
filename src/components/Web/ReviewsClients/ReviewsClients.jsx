...
import AvatarPersona from "../../../assets/imagenes/png/no-avatar.png";
...
const ReviewsClients = () => {
    ...
    return (  
        <Row className="reviews-client">
        <Row>
          <Col lg={4} />
          <Col lg={16} className="reviews-client__title">
            <h2>
...
function CardReview(props) {
    ...
    return (
      <Card className="reviews-client__card">
        <p>{review}</p>
        <Meta
